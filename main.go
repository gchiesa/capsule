...
import (
	...
	podlabelscontroller "github.com/projectcapsule/capsule/controllers/podlabels"
...
func main() {
	...
	if err = (&podlabelscontroller.PodLabelsReconciler{
		Log: ctrl.Log.WithName("controllers").WithName("PodLabels"),
	}).SetupWithManager(ctx, manager); err != nil {
